...
<!-- name="json-scenario-runner" -->
```bash
python -m kenning.scenarios.render_report build/benchmarks/native.md --measurements build/native.json --root-dir build/benchmarks --img-dir build/benchmarks/imgs --report-types performance classification --report-name 'native'
```
...
<!-- name="json-scenario-runner" -->
```bash
python -m kenning.scenarios.render_report build/benchmarks/native.md --measurements build/native.json
```
...
<!-- name="json-scenario-runner" -->
```bash
python -m kenning.scenarios.json_inference_tester tflite-fp32.json build/tflite-fp32.json

python -m kenning.scenarios.render_report build/benchmarks/tflite-fp32.md --measurements build/tflite-fp32.json
```
...
<!-- name="json-scenario-runner" -->
```bash
python -m kenning.scenarios.json_inference_tester tflite-int8.json build/tflite-int8.json

python -m kenning.scenarios.render_report build/benchmarks/tflite-int8.md --measurements build/tflite-int8.json
```
...
<!-- name="json-scenario-runner" -->
```bash
python -m kenning.scenarios.json_inference_tester tvm-avx2-int8.json build/tvm-avx2-int8.json

python -m kenning.scenarios.render_report build/benchmarks/tvm-avx2-int8.md --measurements build/tvm-avx2-int8.json
```
