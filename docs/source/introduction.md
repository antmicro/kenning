...
* [Kenning Zephyr Runtime](kenning-zephyr-runtime) section describes a Zephyr RTOS application that can be used to evaluate models on embedded platforms,
* [Sample RISC-V Zephyr Tracing Report](sample-zephyr-tracing-report) section provides a sample report with detailed runtime analysis for a model executed on a HiFive Unmatched board simulated in Renode using Kenning Zephyr Runtime and Zephelin libraries,
