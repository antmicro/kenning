        ...
        **kwargs:
        ...
        def type_lookup(type_string, shape):
            ...
            map = {
                ...
                "int32": dtypes.Int32TensorType(shape),
                "int16": dtypes.Int16TensorType(shape),
                "int8": dtypes.Int8TensorType(shape),
                "uint64": dtypes.UInt64TensorType(shape),
                "uint32": dtypes.UInt32TensorType(shape),
                "uint16": dtypes.UInt16TensorType(shape),
                "uint8": dtypes.UInt8TensorType(shape),
