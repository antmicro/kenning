...
class Protocol(ArgumentsHandler, ABC):
    ...
    def start_sending_logs(self):
        """
        Starts sending over the protocol all logs, except for the logs
        generated by the operation of sending logs itself (otherwise we
        would have an infinite logging recursion).
        """
        ...
