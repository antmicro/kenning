...
class ROS2CameraNodeDataProvider(DataProvider):
    ...
    def preprocess_input(self, data: sensor_msgs.msg.Image
        ...
        if self._color_format in self._supported_color_formats:
            ...
            if image_format != self._color_format:
                img_orig = self._convert_image_format(img_orig, image_format,
                                                      self._color_format)
    ...
    def _get_io_specification(
            ...
            outputs: Optional[Dict[str, str]] = {}) -> Dict[str, List[Dict]]:
        """
