...
"""
Module used for regression quality report generation.
"""
...
from kenning.core.metrics import compute_regression_metrics
...
def regression_report(
    ...
    **kwargs: Any,
    ...
    """
    Creates regression quality section of the report.
    ...
    **kwargs: Any
    ...
    """
    KLogger.info(
        f'Running regression report for {measurementsdata["model_name"]}'
    )

    metrics = compute_regression_metrics(measurementsdata)

    with path(reports, "regression.md") as reporttemplate:
