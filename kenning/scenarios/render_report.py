...
def automl_report(
    ...
    """
    Creates summary of AutoML process, containing overview of training process
...
def generate_report(
    ...
    automl_stats: Optional[Dict] = None,
):
    """
    ...
    automl_stats : Optional[Dict]
        The statistics gathered during AutoML run.
    """
    from kenning.core.report import create_report_from_measurements
