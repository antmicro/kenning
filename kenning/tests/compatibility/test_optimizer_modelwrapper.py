...
EXPECTED_FAIL = [
    ...
    ("PyTorchAnomalyDetectionPGTAD", "Ai8xCompiler"),
    ("PyTorchAnomalyDetectionPGTAD", "IREECompiler"),
    ("PyTorchAnomalyDetectionPGTAD", "ONNXCompiler"),
    ("PyTorchAnomalyDetectionPGTAD", "TFLiteCompiler"),
    ("PyTorchAnomalyDetectionPGTAD", "TVMCompiler"),
    ("PyTorchAnomalyDetectionPGTAD", "TinygradOptimizer"),
