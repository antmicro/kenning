...
Inference time
```
* *First inference duration* (usually including allocation time): **0.0756687490000445**,
* *Mean*: **0.07456960959047657 s**,
* *Standard deviation*: **0.0003162717572138245 s**,
* *Median*: **0.07452226350000046 s**.
...
* *Mean*: **50.705376569037654 %**,
* *Standard deviation*: **2.8684745600598243 %**,
* *Median*: **50.0 %**.
...
* *Mean*: **9.661589958158997 %**,
* *Standard deviation*: **0.048638183250124686 %**,
* *Median*: **9.7 %**.
