...
Inference time
```
* *First inference duration* (usually including allocation time): **0.07539122800000086**,
* *Mean*: **0.07339701109863984 s**,
* *Standard deviation*: **0.0004912732139699539 s**,
* *Median*: **0.07324175450000325 s**.
...
* *Mean*: **50.57600170502983 %**,
* *Standard deviation*: **2.6793202475468285 %**,
* *Median*: **50.0 %**.
...
* *Mean*: **9.582097186700766 %**,
* *Standard deviation*: **0.08239820204667844 %**,
* *Median*: **9.6 %**.
