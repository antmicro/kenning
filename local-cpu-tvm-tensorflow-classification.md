...
Inference time
```
* *First inference duration* (usually including allocation time): **0.07668648100002429**,
* *Mean*: **0.07305015110544145 s**,
* *Standard deviation*: **0.00037517915849804396 s**,
* *Median*: **0.07301363600004152 s**.
...
* *Mean*: **53.76792372881356 %**,
* *Standard deviation*: **4.238942461168583 %**,
* *Median*: **52.5 %**.
...
* *Mean*: **9.793389830508476 %**,
* *Standard deviation*: **0.06126104658577814 %**,
* *Median*: **9.8 %**.
