...
Inference time
```
* *First inference duration* (usually including allocation time): **0.08325558100000308**,
* *Mean*: **0.08120298547006874 s**,
* *Standard deviation*: **0.0006181917175530189 s**,
* *Median*: **0.08127760650000937 s**.
...
* *Mean*: **50.652637703646235 %**,
* *Standard deviation*: **2.6160531941884484 %**,
* *Median*: **50.0 %**.
...
* *Mean*: **9.588983708301008 %**,
* *Standard deviation*: **0.05198591933453597 %**,
* *Median*: **9.6 %**.
