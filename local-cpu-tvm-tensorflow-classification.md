...
Inference time
```
* *First inference duration* (usually including allocation time): **0.07672417200001291**,
* *Mean*: **0.07435105021972874 s**,
* *Standard deviation*: **0.0004431028840998971 s**,
* *Median*: **0.07430943599996453 s**.
...
* *Mean*: **50.63948362720403 %**,
* *Standard deviation*: **2.6877478262210115 %**,
* *Median*: **50.0 %**.
...
* *Mean*: **10.456003358522251 %**,
* *Standard deviation*: **0.07652494468580354 %**,
* *Median*: **10.5 %**.
