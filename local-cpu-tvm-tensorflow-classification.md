...
Inference time
```
* *First inference duration* (usually including allocation time): **0.07583395300002849**,
* *Mean*: **0.07444982751972755 s**,
* *Standard deviation*: **0.0005814683049769558 s**,
* *Median*: **0.07446090100000902 s**.
...
* *Mean*: **50.55360435875943 %**,
* *Standard deviation*: **2.4334866536707658 %**,
* *Median*: **50.0 %**.
...
* *Mean*: **10.3639564124057 %**,
* *Standard deviation*: **0.057832646768287706 %**,
* *Median*: **10.4 %**.
