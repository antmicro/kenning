...
Inference time
```
* *First inference duration* (usually including allocation time): **0.07475837499998761**,
* *Mean*: **0.07401964119863941 s**,
* *Standard deviation*: **0.0005445433364558186 s**,
* *Median*: **0.07390432299999361 s**.
...
* *Mean*: **50.71214165261382 %**,
* *Standard deviation*: **2.821661745957925 %**,
* *Median*: **50.0 %**.
...
* *Mean*: **10.354384485666106 %**,
* *Standard deviation*: **0.050479995157251 %**,
* *Median*: **10.4 %**.
