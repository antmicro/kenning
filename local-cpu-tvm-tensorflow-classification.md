...
Inference time
```
* *First inference duration* (usually including allocation time): **0.07460856099999091**,
* *Mean*: **0.07432746595646092 s**,
* *Standard deviation*: **0.0005958999286266868 s**,
* *Median*: **0.07443320600003744 s**.
...
* *Mean*: **50.62962184873949 %**,
* *Standard deviation*: **2.41972758377688 %**,
* *Median*: **50.0 %**.
...
* *Mean*: **10.493193277310924 %**,
* *Standard deviation*: **0.03195145406691718 %**,
* *Median*: **10.5 %**.
