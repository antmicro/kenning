...
Inference time
```
* *First inference duration* (usually including allocation time): **0.08069885499998009**,
* *Mean*: **0.07424478960680252 s**,
* *Standard deviation*: **0.0003854889953553697 s**,
* *Median*: **0.07423209799998176 s**.
...
* *Mean*: **53.807080200501254 %**,
* *Standard deviation*: **4.298891890627423 %**,
* *Median*: **52.5 %**.
...
* *Mean*: **9.69766081871345 %**,
* *Standard deviation*: **0.0736530413713938 %**,
* *Median*: **9.7 %**.
