...
Inference time
```
* *First inference duration* (usually including allocation time): **0.07712501299999985**,
* *Mean*: **0.0726168236476193 s**,
* *Standard deviation*: **0.00037351460641726946 s**,
* *Median*: **0.07261499199998411 s**.
...
* *Mean*: **50.42363247863248 %**,
* *Standard deviation*: **3.0805086246098328 %**,
* *Median*: **50.0 %**.
...
* *Mean*: **9.368803418803418 %**,
* *Standard deviation*: **0.05586403508217239 %**,
* *Median*: **9.4 %**.
