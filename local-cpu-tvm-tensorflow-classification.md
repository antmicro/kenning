...
Inference time
```
* *First inference duration* (usually including allocation time): **0.07570730599996978**,
* *Mean*: **0.07446192214557953 s**,
* *Standard deviation*: **0.00046229260599504695 s**,
* *Median*: **0.07446795650000126 s**.
...
* *Mean*: **50.640213746856666 %**,
* *Standard deviation*: **2.73850223386935 %**,
* *Median*: **50.0 %**.
...
* *Mean*: **9.642749371332775 %**,
* *Standard deviation*: **0.10606021657849704 %**,
* *Median*: **9.6 %**.
