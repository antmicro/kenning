...
Inference time
```
* *First inference duration* (usually including allocation time): **0.079159599000036**,
* *Mean*: **0.07243070062449103 s**,
* *Standard deviation*: **0.0003026906159013506 s**,
* *Median*: **0.0724163535000173 s**.
...
* *Mean*: **54.476343856655284 %**,
* *Standard deviation*: **4.011187534111362 %**,
* *Median*: **54.55 %**.
...
* *Mean*: **9.750767918088737 %**,
* *Standard deviation*: **0.08131444083406829 %**,
* *Median*: **9.8 %**.
