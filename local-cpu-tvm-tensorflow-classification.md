...
Inference time
```
* *First inference duration* (usually including allocation time): **0.07393167700001868**,
* *Mean*: **0.07508191662244854 s**,
* *Standard deviation*: **0.0002562245058043136 s**,
* *Median*: **0.07508299450000777 s**.
...
* *Mean*: **50.68911323896753 %**,
* *Standard deviation*: **2.8810982503019584 %**,
* *Median*: **50.0 %**.
...
* *Mean*: **9.496669442131557 %**,
* *Standard deviation*: **0.05341523332482867 %**,
* *Median*: **9.5 %**.
