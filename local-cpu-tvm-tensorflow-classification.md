...
Inference time
```
* *First inference duration* (usually including allocation time): **0.07566262400001733**,
* *Mean*: **0.07408151609047688 s**,
* *Standard deviation*: **0.00041389446441980485 s**,
* *Median*: **0.07416785399996684 s**.
...
* *Mean*: **50.62921585160203 %**,
* *Standard deviation*: **2.6074336220457 %**,
* *Median*: **50.0 %**.
...
* *Mean*: **10.245699831365936 %**,
* *Standard deviation*: **0.07438941530610234 %**,
* *Median*: **10.2 %**.
