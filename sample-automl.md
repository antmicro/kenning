...
```json
{
    ...
    "platform": {
        ...
        "parameters": {
            ...
            "uart_port": "/tmp/renode_uart_el5li8v9/uart",
            "uart_baudrate": 115200,
            "uart_log_port": "/tmp/renode_uart_el5li8v9/uart_log",
            ...
            "profiler_dump_path": "/tmp/renode_profiler_vqdya7gt.dump",
    ...
    "protocol": {
        ...
        "parameters": {
            "port": "/tmp/renode_uart_el5li8v9/uart",
            "baudrate": 115200,
            "error_recovery": true,
            "timeout": 30
        }
...
```json
{
    ...
    "platform": {
        ...
        "parameters": {
            "zephyr_build_path": "workspace/kzr_build",
            "llext_binary_path": null,
            "uart_port": "/tmp/renode_uart_4jqwpp1_/uart",
            "uart_baudrate": 115200,
            "uart_log_port": "/tmp/renode_uart_4jqwpp1_/uart_log",
            "uart_log_baudrate": 115200,
            "auto_flash": false,
            "openocd_path": "openocd",
            "sensor": null,
            ...
            "disable_opcode_counters": false,
            "disable_profiler": false,
            "profiler_dump_path": "/tmp/renode_profiler_r98ep2u6.dump",
            "profiler_interval_step": 10.0,
            "runtime_init_log_msg": "Inference server started",
            "runtime_init_timeout": 30,
            "name": "max32690evkit/max32690/m4",
    ...
    "protocol": {
        "type": "kenning.protocols.uart.UARTProtocol",
        "parameters": {
            "port": "/tmp/renode_uart_4jqwpp1_/uart",
            "baudrate": 115200,
            "error_recovery": true,
            "timeout": 30
        }
...
```json
{
    ...
    "platform": {
        ...
        "parameters": {
            "zephyr_build_path": "workspace/kzr_build",
            "llext_binary_path": null,
            "uart_port": "/tmp/renode_uart_48nq80u8/uart",
            "uart_baudrate": 115200,
            "uart_log_port": "/tmp/renode_uart_48nq80u8/uart_log",
            "uart_log_baudrate": 115200,
            "auto_flash": false,
            "openocd_path": "openocd",
            "sensor": null,
            ...
            "disable_opcode_counters": false,
            "disable_profiler": false,
            "profiler_dump_path": "/tmp/renode_profiler_mqbyso7a.dump",
            "profiler_interval_step": 10.0,
            "runtime_init_log_msg": "Inference server started",
            "runtime_init_timeout": 30,
            "name": "max32690evkit/max32690/m4",
    ...
    "protocol": {
        "type": "kenning.protocols.uart.UARTProtocol",
        "parameters": {
            "port": "/tmp/renode_uart_48nq80u8/uart",
            "baudrate": 115200,
            "error_recovery": true,
            "timeout": 30
        }
...
```json
{
    ...
    "platform": {
        ...
        "parameters": {
            "zephyr_build_path": "workspace/kzr_build",
            "llext_binary_path": null,
            "uart_port": "/tmp/renode_uart_k4roqo9o/uart",
            "uart_baudrate": 115200,
            "uart_log_port": "/tmp/renode_uart_k4roqo9o/uart_log",
            "uart_log_baudrate": 115200,
            "auto_flash": false,
            "openocd_path": "openocd",
            "sensor": null,
            ...
            "disable_opcode_counters": false,
            "disable_profiler": false,
            "profiler_dump_path": "/tmp/renode_profiler_qcullgj1.dump",
            "profiler_interval_step": 10.0,
            "runtime_init_log_msg": "Inference server started",
            "runtime_init_timeout": 30,
            "name": "max32690evkit/max32690/m4",
    ...
    "protocol": {
        "type": "kenning.protocols.uart.UARTProtocol",
        "parameters": {
            "port": "/tmp/renode_uart_k4roqo9o/uart",
            "baudrate": 115200,
            "error_recovery": true,
            "timeout": 30
        }
...
```json
{
    ...
    "platform": {
        ...
        "parameters": {
            "zephyr_build_path": "workspace/kzr_build",
            "llext_binary_path": null,
            "uart_port": "/tmp/renode_uart_odtcz624/uart",
            "uart_baudrate": 115200,
            "uart_log_port": "/tmp/renode_uart_odtcz624/uart_log",
            "uart_log_baudrate": 115200,
            "auto_flash": false,
            "openocd_path": "openocd",
            "sensor": null,
            ...
            "disable_opcode_counters": false,
            "disable_profiler": false,
            "profiler_dump_path": "/tmp/renode_profiler_2mjfaymj.dump",
            "profiler_interval_step": 10.0,
            "runtime_init_log_msg": "Inference server started",
            "runtime_init_timeout": 30,
            "name": "max32690evkit/max32690/m4",
    ...
    "protocol": {
        "type": "kenning.protocols.uart.UARTProtocol",
        "parameters": {
            "port": "/tmp/renode_uart_odtcz624/uart",
            "baudrate": 115200,
            "error_recovery": true,
            "timeout": 30
        }
...
- *The number of generated models*: **41**
