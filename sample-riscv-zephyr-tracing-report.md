...
```json
{
    ...
    "platform": {
        ...
        "parameters": {
            ...
            "zephyr_base": null,
            "uart_port": "/tmp/renode_uart_yb_bzl3m/uart",
            "uart_baudrate": 115200,
            "uart_log_port": "/tmp/renode_uart_yb_bzl3m/uart_log",
            ...
            "profiler_dump_path": "/tmp/renode_profiler_neht02v7.dump",
    ...
    "protocol": {
        ...
        "parameters": {
            "port": "/tmp/renode_uart_yb_bzl3m/uart",
            "baudrate": 115200,
            "error_recovery": true,
            "timeout": 30
        }
...
```
### Instructions stats
* *Instructions counters per inference pass*: **1315347**
